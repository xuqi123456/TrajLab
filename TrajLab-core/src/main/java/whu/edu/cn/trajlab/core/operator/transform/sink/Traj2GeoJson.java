package whu.edu.cn.trajlab.core.operator.transform.sink;
...
import whu.edu.cn.trajlab.base.point.StayPoint;
...
public class Traj2GeoJson {
  ...
  public static JSONObject convertStayPointFeatures(StayPoint stayPoint) {
    ...
    featuresObject.put("whu/edu/cn/trajlab/base/mbr", convertMbr(stayPoint.getMbr()));
