...
public class XZTCoding implements TimeCoding {
    ...
    public int timeToBin(long time) {
        ZonedDateTime zonedDateTime = ZonedDateTime.ofInstant(Instant.ofEpochSecond(time), CodingConstants.TIME_ZONE);
    ...
    public static ZonedDateTime timeToZonedTime(long time) {
        return ZonedDateTime.ofInstant(Instant.ofEpochSecond(time), CodingConstants.TIME_ZONE);
    }
