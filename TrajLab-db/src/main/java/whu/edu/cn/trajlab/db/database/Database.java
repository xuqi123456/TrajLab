...
public final class Database {
    ...
    public MetaTable getMetaTable() throws IOException {
        return new MetaTable(getTable(DBConstants.META_TABLE_NAME));
    }
    ...
    public void createDataSet(DataSetMeta dataSetMeta) throws IOException {
        ...
        for (IndexType indexType : indexMetaMap.keySet()) {
            for (IndexMeta indexMeta : indexMetaMap.get(indexType)) {
                createTable(indexMeta.getIndexTableName(), DBConstants.INDEX_TABLE_CF, indexMeta.getSplits());
            }
        }
    ...
    public void addIndexMeta(String dataSetName, IndexMeta newIndexMeta) throws IOException {
        try {
            ...
            createTable(newIndexMeta.getIndexTableName(), DBConstants.INDEX_TABLE_CF, newIndexMeta.getSplits());
    ...
    public void initDataBase() throws IOException {
        // 创建DataSetMeta表
        createTable(DBConstants.META_TABLE_NAME, DBConstants.META_TABLE_COLUMN_FAMILY, null);
    }
