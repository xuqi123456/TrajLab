...
public class XZ2IndexStrategy extends IndexStrategy {
    ...
    private static final int PHYSICAL_KEY_BYTE_LEN = Short.BYTES + XZ2Coding.BYTES + CodingConstants.MAX_OID_LENGTH + CodingConstants.MAX_TID_LENGTH;
    private static final int LOGICAL_KEY_BYTE_LEN = PHYSICAL_KEY_BYTE_LEN - Short.BYTES - CodingConstants.MAX_TID_LENGTH;
    private static final int SCAN_RANGE_BYTE_LEN =  PHYSICAL_KEY_BYTE_LEN - CodingConstants.MAX_OID_LENGTH - CodingConstants.MAX_TID_LENGTH;
