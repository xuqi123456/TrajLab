package whu.edu.cn.trajlab.db.database.driver;
...
public class TextBulkLoadDriver extends Configured {
    ...
    private void setUpConfiguration(String inPath, String outPath) {
        ...
        conf.set(DBConstants.BULK_LOAD_INPUT_FILE_PATH_KEY, inPath);
        conf.set(DBConstants.BULK_LOAD_TEMP_FILE_PATH_KEY, outPath);
    }
