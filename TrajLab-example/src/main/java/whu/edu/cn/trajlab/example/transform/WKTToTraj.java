 ...
 * @date 2023/11/17
 */
public class WKTToTraj {
    private static final Logger LOGGER = LoggerFactory.getLogger(WKTToTraj.class);
    @Test
    public void WKTToTrajFromConf() throws JsonParseException {
        String inPath =
                Objects.requireNonNull(TrajToGeojson.class.getResource("/ioconf/load/WKTLoad.json"))
                        .getPath();
