 ...
 * @date 2023/11/24
 */
public class TrajToKML {
    private static final Logger LOGGER = LoggerFactory.getLogger(TrajToKML.class);
    @Test
    public void TrajToKMLFromConf() throws IOException {
        String inPath =
                Objects.requireNonNull(TrajToGeojson.class.getResource("/ioconf/store/KMLStore.json"))
                        .getPath();
