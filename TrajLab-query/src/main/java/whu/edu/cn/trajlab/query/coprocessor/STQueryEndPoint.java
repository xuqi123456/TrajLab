...
public class STQueryEndPoint extends QueryCondition.QueryService implements Coprocessor, CoprocessorService {
    ...
    private QueryCondition.TrajectoryResult buildTrajectoryResult(Result result){
        return QueryCondition.TrajectoryResult.newBuilder()
                ...
                .setTrajPointList(
                        ByteString.copyFrom(TrajectorySerdeUtils.getByteArrayByQualifier(result, DBConstants.TRAJ_POINTS_QUALIFIER)))
                .setObjectId(ByteString.copyFrom(
                        TrajectorySerdeUtils.getByteArrayByQualifier(result, DBConstants.OBJECT_ID_QUALIFIER)))
                .setTid(ByteString.copyFrom(
                        TrajectorySerdeUtils.getByteArrayByQualifier(result, DBConstants.TRAJECTORY_ID_QUALIFIER)))
                .build();
    }
}
