 ...
 * @date 2023/12/01
 */
public class IDTemporalQuery extends AbstractQuery implements Serializable {
  ...
  public List<Trajectory> executeQuery(List<RowKeyRange> rowKeyRanges) throws IOException {
    ...
    IDTemporalQueryCondition idTemporalQueryCondition = (IDTemporalQueryCondition) abstractQueryCondition;
    TemporalQueryCondition temporalQueryCondition = idTemporalQueryCondition.getTemporalQueryCondition();
